...
def c(s,arg=None):
  ...
  if arg:
    ...
    # symbols
    if arg == 'call2': return _c(s,modifier=1,intensity=9,color=2)
    if arg == 'line2': return _c(s,modifier=2,intensity=3,color=0)
    if arg == 'return2': return _c(s,modifier=1,intensity=9,color=3)
    if arg == 'exception2': return _c(s,modifier=1,intensity=9,color=1)
...
class State:
  ...
  def _(self,dispatch_class:type('call',(),{})):
    ...
    s = (
      ...
      f"{ws(spaces=len(stack)-1)}{self.function}{c(=>)} "
    )
