...
class StateCollection:
  def __init__(self,states):
    ...
    self.states = open('/Users/alberthan/VSCodeProjects/HDLogger/youtube-dl/logs/state.serialized_arg.log','r')

  def initialize_states_data(self):
    filepath = Path('~/VSCodeProjects/HDLogger/youtube-dl/logs/state.serialized_arg.log')
