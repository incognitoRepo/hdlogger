...
class HiDefTracer:
  ...
  def dispatch_call(self, frame, arg):
    ...
    try:
      kwds = {'call_args': self.state.frame.f_locals}
      pickleable = TraceHookCallbackCall(**kwds)
    except ValidationError as e:
  ...
  def dispatch_line(self, frame, arg):
    ...
    try:
      kwds = {'line_args': self.state.frame.f_locals}
      pickleable = TraceHookCallbackLine(**kwds)
    except ValidationError as e:
  ...
  def dispatch_return(self, frame, arg):
    ...
    try:
      ...
      pickleable = TraceHookCallbackReturn(**kwds)
    except ValidationError as e:
      with open('logs/tracer.dispatch_line.log','a') as f:
        f.write(stackprinter.format(sys.exc_info()))
  ...
  def dispatch_exception(self, frame, arg):
    if arg is None: return ""
    try:
      kwds = {'exception_value': arg}
      pickleable = TraceHookCallbackException(**kwds)
    except ValidationError as e:
