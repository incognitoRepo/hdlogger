...
rm -rf '/Users/alberthan/VSCodeProjects/vytd/src/youtube-dl/logs'
mkdir '/Users/alberthan/VSCodeProjects/HDLogger/youtube-dl/logs'
...
if [[ "$pwd" != $ytdl_path ]]; then
  ...
  python3 -i -m pdb -m youtube_dl $video_url
