...
def main2():
  ...
  write_file(pformat(return_values),'return_values')
  write_file(pformat(serialized_as_hex),'serialized_as_hex')
  write_file(pformat(deserialized_to_pyobj),'deserialized_to_pyobj')
  write_file(pformat(deserialized),'deserialized')
  write_file(pformat(output),'output')
