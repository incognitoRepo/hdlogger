...
def main2():
  ...
  write_file(pformat(return_values),'return_values.log')
  write_file(pformat(serialized_as_hex),'serialized_as_hex.log')
  write_file(pformat(deserialized_to_pyobj),'deserialized_to_pyobj.log')
  write_file(pformat(deserialized),'deserialized.log')
  write_file(pformat(output),'output.log')
