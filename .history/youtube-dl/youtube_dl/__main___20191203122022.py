...
def main2():
  ...
  with captured_output() as (out,err):
    try:
      ...
      output = out.getvalue()
      write_file(pformat(return_values),'logs/main.return_values.log')
      write_file(pformat(deserialized),'logs/main.deserialized_arg.log',mode="a")
      write_file(output,'logs/main.output.log')
